...
: G4UserRunAction(),
  ...
  particleType(0),
  leptonScatteringAngle(0.0), leptonCosTheta(1.0), inelasticity(0.0),
   showerNSecondaries(0), showerLongitudinalProfile(0.0), showerLateralSpread(0.0),
  nPhotonsProduced(0), nElectronsProduced(0), nPositronsProduced(0), nGammasProduced(0),
  nPionsProduced(0), nProtonSecondaries(0), nNeutronSecondaries(0), nKaonsProduced(0)
{}
...
void RunAction::BeginOfRunAction(const G4Run*) {
 ...
 fTree->Branch("eventID", &eventID, "eventID/I");
  ...
  fTree->Branch("particleType", &particleType, "particleType/I");
  fTree->Branch("primaryFinalPDG", &primaryFinalPDG, "primaryFinalPDG/I");
  fTree->Branch("primaryOscillationProcessInvoked", &primaryOscillationProcessInvoked, "primaryOscillationProcessInvoked/O");
  fTree->Branch("primaryOscillationFlavorChanged", &primaryOscillationFlavorChanged, "primaryOscillationFlavorChanged/O");
  fTree->Branch("primaryOscillationPDGBefore", &primaryOscillationPDGBefore, "primaryOscillationPDGBefore/I");
  fTree->Branch("primaryOscillationPDGAfter", &primaryOscillationPDGAfter, "primaryOscillationPDGAfter/I");
  fTree->Branch("nOscillationSteps", &nOscillationSteps, "nOscillationSteps/I");
 ...
 // ========== VALIDATION BRANCHES ==========                                                                                                                            
  ...
  fTree->Branch("leptonCosTheta", &leptonCosTheta, "leptonCosTheta/D");
  fTree->Branch("inelasticity", &inelasticity, "inelasticity/D");
...
void RunAction::FillEvent(EventAction* evt)
{
  ...
  step_parentID.clear();
  step_PDG.clear();
  step_preX.clear(); step_preY.clear(); step_preZ.clear();
  step_postX.clear(); step_postY.clear(); step_postZ.clear();
